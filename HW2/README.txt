...
Fun Secret Features:
	...
	If "Mode" button has focus you can use the arrow keys to drive the robot freestyle
		space bar will send a stop command, and will reset the iRobot Create to safe 
		mode if wheels drop when doing a wheelie
...
RobotPositionPanel.java
	Handles drawing the path of the iRobot Create during Wall Following execution.
SensorData.java
...
WallFollowingRobot.java
	...
	This class extends the normal functionality of Robot.java, and allows for a very different
	experience.