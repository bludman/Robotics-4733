...
public interface CommandSet 
{
	...
	/**
	 * Sets the baud rate.
	 * @param baudCode Baud code corresponding to pointA baud rate.
	 * @return The command written.
	 */
	...
	/**
	 * Specifies songs that the iRobot Create can play at pointA later time. Not currently implemented.
	 * @return The command written.
	 */
	public byte[] song();

	/**
	 * Selects pointA song to play from those added to the iRobot Create.
	...
	/**
	 * Specifies pointA script to be played later. Currently not implemented.
	 * @return The command written.
	 */
	public byte[] script();

	/**
	 * Loads pointA previously defined script to be played.
	 * @return The command written.
	 */
	public byte[] playScript();

	/**
	 * Returns the values of pointA previously stored script.
	 * @return The command written.
	 */
